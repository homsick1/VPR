...
var summaryControl = L.Control.extend({
  ...
  update: function(output) {
    ...
    displayDuration.innerHTML = '<b>Продолжительность поездки:</b> '
    ...
    displayDistance.innerHTML = '<b>Расстояние поездки:</b> '
      + distance.toString() + ' км';
    ...
    CTDisplay.innerHTML = '<b>Время вычисления: </b>' + (ct / 1000) + ' с';
